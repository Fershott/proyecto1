  ...
  return (
    <header className="overview" aria-labelledby="welcome-heading">
      <div className="overview__brand">
        ...
        <div>
          <p className="overview__eyebrow">Tu hub de estudio</p>
          <h1 id="welcome-heading" className="overview__title">
            CogniCore
          </h1>
          <p className="overview__description">
            Un espacio guiado para personas neurodivergentes: planifica con calma, enfócate con ritmo y escucha tus
            resúmenes cuando lo necesites.
          </p>
        </div>
      </div>
      <div className="overview__stickers" aria-hidden="true">
        <span className="sticker sticker--pulse">Modo foco adaptable</span>
        <span className="sticker sticker--accent">Recordatorios amables</span>
        <span className="sticker sticker--outline">Audio + resúmenes 360°</span>
      </div>
