...
const SummaryAssistant = ({
  ...
  const handleSubmit = (event) => {
    ...
    if (!text.trim()) {
      alert('Escribe un texto o sube un archivo para generar el resumen.')
      return
    }
  ...
  return (
    <section
      ...
      data-sticker="Resúmenes hápticos"
      data-icon="🔊"
    >
      <header className="panel__header">
        <div>
          ...
          <p className="panel__subtitle">
            Sube un documento PDF, Word, PowerPoint o TXT, o pega tu texto. Podrás escuchar el resumen o el contenido completo.
          </p>
        </div>
      </header>
          ...
          <div className="summary__upload">
            ...
            >
              ...
              <span className="summary__upload-copy">
                <span className="summary__upload-title">Cargar archivo holográfico</span>
                <span className="summary__upload-subtitle">
                  Lanza tus PDF, Word, PowerPoint o TXT futuristas
                </span>
              </span>
            </label>
          </div>
